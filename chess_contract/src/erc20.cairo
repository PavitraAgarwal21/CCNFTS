...
pub mod erc20 {
    ...
    use starknet::{ContractAddress, get_caller_address, contract_address_const, storage::Map};
    #[storage]
    struct Storage {
        name: felt252,
        symbol: felt252,
    ...
    fn constructor(ref self: ContractState, recipient: ContractAddress,) {
        self.name.write('CHESSTOKEN');
        self.symbol.write('CHT');
        self.decimals.write(1);
        self.mint(recipient, 100000);
    }
...
// #[cfg(test)]
// mod tests {
//     use super::{erc20, IERC20Dispatcher, IERC20DispatcherTrait, erc20::{Event, Transfer,
//     Approval}};

//     use starknet::{
//         ContractAddress, SyscallResultTrait, syscalls::deploy_syscall,
...
//             recipient.into(),
//             array![recipient.into(), token_name, decimals.into(), initial_supply,
//             symbols].span(), false
//         )
//             .unwrap_syscall();
...
//         assert(
//             dispatcher.allowance(caller, spender) == amount + 100, 'incorrect increased
//             allowance'
//         );
