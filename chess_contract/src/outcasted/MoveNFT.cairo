...
mod MoveNFT {
    ...
    impl IMoveImpl of ImoveTrait {
        ...
        fn playmove(ref self: ContractState, _move: u256) {
            ...
            let new_chess_board_after_ai = self
                ._play_move(current_board_state, _move, depth, tokenId, caller);
            ...
            if self.win_lose.read(tokenId) { // mint_token(caller, self.get_amt_mint(tokenId)) ;
            // exit game 
            }
